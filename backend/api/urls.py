...
from .views import UserViewSet, TimeViewSet, FaseViewSet, JogoViewSet, PalpiteViewSet, RankingViewSet, GrupoPrivadoViewSet, AlterarSenhaView, EstatisticasViewSet, TabelaGruposViewSet, PalpiteCampeaoViewSet
